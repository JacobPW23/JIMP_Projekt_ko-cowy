...
if(*obecne_pole_na_mapie=='b')
{
	switch(zwrot)
	{
		...
		case 'E': stan->zwrot='S';*obecne_pole_na_mapie='c';if(*nr_kol==kolumn_na_mapie-1) return 1; else *nr_wier++; break;
...
if(*obecne_pole_na_mapie=='c')
{
       switch(zwrot)
       {
		...
		case 'S': stan->zwrot='E';*obecne_pole_na_mapie='b';if(*nr_kol==wierszy_na_mapie-1) return 1; else *nr_kol++; break;
		case 'W': stan->zwrot='S';*obecne_pole_na_mapie='b';if(*nr_kol==kolumn_na_mapie-1) return 1; else *nr_wier++; break;
